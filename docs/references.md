...
Design research included [BruceLanLan/sol-luna-engineering-workflow](https://github.com/BruceLanLan/sol-luna-engineering-workflow). This repository is not a fork, does not modify or distribute that project, and does not use it as an installation source. The v0.1.0 implementation was written independently from the requirements in this repository.
